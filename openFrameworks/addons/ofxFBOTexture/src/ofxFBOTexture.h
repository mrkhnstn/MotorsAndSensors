...
/**********************************
 THIS IS AN OLD VERSION OF THIS ADDON, INCLUDED IN THIS BUNDLE FOR COMPATIBILITY
 PLEASE CHECK www.openframeworks.cc/forum FOR LATEST NEWS ON CURRENT VERSION 
 **********************************/
...
public:
	...
	void allocate(int w, int h, int internalGlDataType = GL_RGBA, int numSamples = 0, bool useARB = true);
	void begin();
	void end();
