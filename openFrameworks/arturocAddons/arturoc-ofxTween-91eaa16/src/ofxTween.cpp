...
ofxEasingBack		ofxTween::easingback;
ofxEasingBounce		ofxTween::easingbounce;
ofxEasingCirc		ofxTween::easingcirc;
ofxEasingCubic		ofxTween::easingcubic;
ofxEasingElastic		ofxTween::easingelastic;
ofxEasingExpo		ofxTween::easingexpo;
ofxEasingLinear		ofxTween::easinglinear;
ofxEasingQuad		ofxTween::easingquad;
ofxEasingQuart		ofxTween::easingquart;
ofxEasingQuint		ofxTween::easingquint;
ofxEasingSine		ofxTween::easingsine;
