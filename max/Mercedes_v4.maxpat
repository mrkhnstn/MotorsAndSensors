{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 224.0, 203.0, 536.0, 337.0 ],
		"bglocked" : 0,
		"defrect" : [ 224.0, 203.0, 536.0, 337.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "print",
					"patching_rect" : [ 395.0, 89.0, 34.0, 18.0 ],
					"id" : "obj-4",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "s usbmodem411_toSerial",
					"patching_rect" : [ 281.0, 137.0, 147.0, 20.0 ],
					"id" : "obj-3",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "prepend /sensor",
					"patching_rect" : [ 15.0, 255.0, 97.0, 20.0 ],
					"id" : "obj-59",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "SensorMotorBank usbmodem621",
					"patching_rect" : [ 10.0, 35.0, 189.0, 20.0 ],
					"id" : "obj-2",
					"fontname" : "Arial",
					"numinlets" : 0,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "SensorMotorBank usbmodem411",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "s toServo",
					"patching_rect" : [ 15.0, 190.0, 61.0, 20.0 ],
					"id" : "obj-147",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 140.0, 99.0, 20.0 ],
					"id" : "obj-11",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 285.0, 140.0, 20.0 ],
					"id" : "obj-36",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
